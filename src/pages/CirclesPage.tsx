...
const CirclesPage = () => {
    ...
    const [
        selectedCircleForStudents,
        setSelectedCircleForStudents,
    ] = useState<Halaqa | null>(null);

    const [form, setForm] =
        useState<HalaqaPayload>(
            emptyHalaqaPayload
        );
    ...
    return (
        ...
        >
            ...
            >
                ...
                <DialogContent
                    dir="rtl"
                    className="font-tajawal max-w-3xl"
                >
                    ...
                    <DialogHeader>
                        ...
                        <DialogTitle>
                            ...
                            {selectedCircleForStudents?.className ??
                                "الحلقة"}
